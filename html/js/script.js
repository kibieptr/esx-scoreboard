...
$(document).ready(function() {
    window.addEventListener('message', (event) => {
        ...
        if (data.action == "updateScoreboard") {
            ...
            $('#onlinepemerintah').html(data.onlinepemerintah + ' <i class="fa-solid fa-earth-americas noSelect" style="color: #0059fd;"></i')
            $('#onlinepedagang').html(data.onlinepedagang + ' <i class="fa-solid fa-utensils noSelect" style="color: #cd52a4;"></i')
        }
        ...
        if (data.action == "playerInfoUpdate") {
            $("#tooFarMessage").hide()
            $("#playerName").html(data.roleplayName+' <i class="fa-solid fa-user-tag"></i>')
            ...
            $("#job").html(data.job+' <i class="fa-solid fa-briefcase"></i>')
            if (data.tooFar == true) {
